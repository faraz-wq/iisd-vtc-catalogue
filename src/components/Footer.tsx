        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Providing quality education and vocational training through our
              network of colleges, preparing students for successful careers in
              healthcare, IT, and other professional fields.
            </p>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  Chatrapati Shivaji Maharaj College
                </a>
              </li>
              <li>
                <a
