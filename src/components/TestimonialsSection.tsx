...
const TESTIMONIALS = [
  {
    id: 1,
    quote:
      "The paramedical program at Chatrapati Shivaji Maharaj College gave me practical skills that employers value. I secured a job at a top hospital immediately after graduation.",
    name: "Aditya Sharma",
  ...
  },
  {
    id: 2,
    quote:
      "The IT faculty at IISD are industry professionals who bring real-world experience to the classroom. The hands-on projects prepared me perfectly for my current role.",
    name: "Priya Patel",
  ...
  },
  {
    id: 3,
    quote:
      "Royal College's vocational training gave me specialized skills in medical lab technology. The 70% practical training approach made all the difference in my career.",
    name: "Rahul Deshmukh",
    title: "Medical Lab Technician, Fortis Healthcare",
    imageSrc:
      "https://images.unsplash.com/photo-1663576139896-f1e9b9537634?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
  ...
  },
  {
    id: 4,
    quote:
      "The pharmacy program at N.H. Paramedical College provided me with comprehensive knowledge and practical experience. The faculty support was exceptional.",
    name: "Sneha Joshi",
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-300">
            ...
            after graduating from our institutions
          </p>
        </div>
              ...
              <div className="relative">
                ...
                <div className="opacity-0 pointer-events-none">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-transparent font-semibold">
                      ...
                      <h4 className="text-transparent text-sm">
