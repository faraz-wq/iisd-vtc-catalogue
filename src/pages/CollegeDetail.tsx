...
const CollegeDetail = () => {
  ...
  // Find the college in the array based on the `collegeId`
  const college = COLLEGES.find(college => college.shortName === collegeId);

  // If the college is not found, show a "Not Found" page
  if (!college) {
    return (
                  ...
                  <div className="mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="flex items-start space-x-3">
                        <div className={`p-2 rounded-full bg-maroon-500 text-white`}>
                  ...
                  <div className="space-y-4">
                    {college.events.map((event, index) => (
                      <div key={index} className="flex items-start space-x-4 border-b border-gray-100 last:border-0 pb-4 last:pb-0">
                        <div className={`p-2 rounded-lg bg-maroon-500 text-white flex-shrink-0`}>
                      ...
                      <ul className="space-y-3">
                        {college.facilities.map((facility, index) => (
                          <li key={index} className="flex items-center">
                            <Check className={`h-5 w-5 mr-2 text-maroon-500`} />
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    {college.faculty.map((faculty, index) => (
                      <div key={index} className="text-center">
                        ...
                        <p className={`text-sm text-maroon-500 font-medium`}>{faculty.position}</p>
